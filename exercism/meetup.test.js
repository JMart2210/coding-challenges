...
// date.getDate();
// // => 13
// const meetup = (yr, m, desc, d) => {
//   m = m - 1;
//   let start = 1;
//   let date = null;
//   let dayWanted = 0;
//   switch (d){ // This converts the day of the week string to a number, saved in "dayWanted"
//     case "Monday":
//       dayWanted = 1;
//       break;
//     case "Tuesday":
...
//       break;
//   }
//   switch (desc){ // This tells us what day to start looking at
//     case "teenth":
//       start = 13;
//       break;
//     case "second":
...
//       break;
//     case "last":
//       start = new Date(yr, m + 1, 0).getDate() - 6; //This sets where to start looking by grabbin the "zeroeth" day of the next month and subtracting 6.
//       break;
//     default:
//       break;
//   }
//   while (date?.getDay() !== dayWanted ){
//     date = new Date(yr, m, start)
//     start++;
//   }
//   return date;
// } //My Original solution is above. 

// This was highest rated solution. Much simpler approach that uses indexOf an array and object bracket notation instead of switch statements. Also, modulus derives the day as opposed to a while loop. 
