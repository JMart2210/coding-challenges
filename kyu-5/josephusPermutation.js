...
function josephus(items,k){
    ...
    while (items.length > 0){
        ...
        result.push(...items.splice(counter, 1));
    }
    return result;
}
console.log(josephus([1,2,3,4,5,6,7],3));

// I like how they used the modulus to simplify the process of finding the next index. 
// my solution used a while loop that is a little harder to read.
function josephus(items, k){
    var result = [], index = 0;
    while (items.length > 0){
